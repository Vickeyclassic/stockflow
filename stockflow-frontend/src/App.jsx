...
function AuthenticatedApp() {
  ...
  return <div className="shell">
    ...
    <nav aria-label="Main navigation">{(user.role === 'ADMIN' ? [...pages, 'users'] : pages).map(name => <a key={name} href={`#${name}`} aria-current={page === name ? 'page' : undefined}>{pageLabel(name)}</a>)}<span>V1.3</span></nav>
