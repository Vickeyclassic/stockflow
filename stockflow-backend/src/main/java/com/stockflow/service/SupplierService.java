...
public class SupplierService {
    ...
    public SupplierService(SupplierRepository suppliers, ProductRepository products) { this.suppliers = suppliers; this.products = products; }
    ...
    public void delete(Long id) {
        ...
        if (products.existsBySupplierId(id)) throw DomainException.conflict("RESOURCE_IN_USE", "Supplier is used by products and cannot be deleted");
